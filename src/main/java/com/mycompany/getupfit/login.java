...
public  class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setForeground(new java.awt.Color(169, 213, 136));

        jPanel4.setBackground(new java.awt.Color(216, 252, 193));
        ...
        jLabel2.setForeground(new java.awt.Color(27, 50, 27));
        jLabel2.setText("Login");

        jLabel6.setFont(new java.awt.Font("Lucida Console", 0, 12)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(27, 50, 27));
        jLabel6.setText("Para acceder ingresa tus datos");
        ...
        jPanel8.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 34, 0), 4, true));

        jButton11.setFont(new java.awt.Font("Lucida Console", 0, 18)); // NOI18N
        jButton11.setForeground(new java.awt.Color(0, 24, 0));
        ...
        jLabel7.setForeground(new java.awt.Color(27, 50, 27));
        jLabel7.setText("No tienes cuenta? Crea una aqui.");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        new register().setVisible(true); // Abre la ventana login
        dispose();
